              ...
              <div>
                <div>
                  <div className='outlines'>
                    ...
                    <div>
                      <h2 style={{ fontSize: 14, lineHeight: '1.2em', }}>
                        <a href="https://www.acctav.com/support-policy" style={{ textDecoration: 'none' }} target="_self"><span style={{ fontWeight: 'bold', }}><span style={{ fontSize: 14, }}><span><span style={{ letterSpacing: '0.09em', }}><span style={{ fontFamily: 'helvetica-w01-light,helvetica-w02-light,sans-serif', }}>SUPPORT POLICY</span></span></span></span></span></a></h2></div>
